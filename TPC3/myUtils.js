...
async function getAlunos(){
    const resp = await axios.get("http://localhost:7777/alunos")
    return resp.data
}

async function getCursos(){
    const resp = await axios.get("http://localhost:7777/cursos")
    return resp.data
}

async function getInstrumentos(){
    const resp = await axios.get("http://localhost:7777/instrumentos")
    return resp.data
}
